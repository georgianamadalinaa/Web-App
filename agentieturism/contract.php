...
<header class="art-header">
    ...
    <nav class="art-nav">
        <ul class="art-hmenu">
            ...
            <li><a href="contract.php" class="active">Contract</a></li>
            ...
            <div class="art-content-layout-row">
                <div class="art-layout-cell art-content">
                    <article class="art-post art-article">
                        <h2 class="art-postheader">Contracte</h2>
                        <div class="art-postcontent art-postcontent-0 clearfix">
                            <ul>
                                <li><a href="contract_inserare.php">Inserare Contract</a></li>
                                <li><a href="contract_cautare.php">Căutare Contract</a></li>
                                <li><a href="contract_modificare.php">Modificare Contract</a></li>
                                <li><a href="contract_stergere.php">Ștergere Contract</a></li>
<li><a href="filtrare.php">Filtrare Suma Plata</a></li>
