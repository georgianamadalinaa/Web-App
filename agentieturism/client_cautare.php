...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM Client WHERE Nume_Cli LIKE '%$nume%'";
...
<body>
    ...
    if ($result && $result->num_rows > 0) {
        echo "<table><tr><th>CNP</th><th>Nume</th><th>Prenume</th><th>Adresa</th><th>Telefon</th></tr>";
        while($row = $result->fetch_assoc()) {
            echo "<tr><td>".$row["Id_CNP"]."</td><td>".$row["Nume_Cli"]."</td><td>".$row["Prenume_Cli"]."</td><td>".$row["Adresa_Cli"]."</td><td>".$row["Telefon_Cli"]."</td></tr>";
        }
        echo "</table>";
