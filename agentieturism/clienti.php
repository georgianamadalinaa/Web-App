            ...
            <div class="art-content-layout-row">
                <div class="art-layout-cell art-content">
                    <article class="art-post art-article">
                        <h2 class="art-postheader">Clienti</h2>
                        <div class="art-postcontent art-postcontent-0 clearfix">
                            <ul>
                                <li><a href="client_inserare.php">Inserare Client</a></li>
            <li><a href="client_cautare.php">Cautare Client</a></li>
            <li><a href="client_modificare.php">Modificare Client</a></li>
            <li><a href="client_stergere.php">Stergere Client</a></li>  
 <li><a href="client_filtrare.php">Filtrare Client</a></li>                          </ul>
                        </div>
                    </article>
                </div>
            </div>
