...
$sql = "SELECT * FROM contract ORDER BY Suma_plata ASC";
                            ...
                            <article class="art-post art-article">
                                <div class="art-postcontent art-postcontent-0 clearfix">
                                    ...
                                    if ($result->num_rows > 0) {
                                        echo "<table>";
                                        echo "<tr><th>Nr Contract</th><th>Client</th><th>Suma Plata</th></tr>";
                                        while($row = $result->fetch_assoc()) {
                                            echo "<tr><td>" . $row["Nr_Contract"] . "</td><td>" . $row["Id_CNP"] . "</td><td>" . $row["Suma_plata"] . "</td></tr>";
                                        }
                                        echo "</table>";
                                    } else {
                                        echo "Nu există contracte.";
                                    }
                                    $conn->close();
                                    ?>
                                </div>
