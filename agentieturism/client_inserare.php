...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Client (Id_CNP, Nume_Cli, Prenume_Cli, Adresa_Cli, Telefon_Cli) VALUES ('$cnp', '$nume', '$prenume', '$adresa', '$telefon')";

    if ($conn->query($sql) === TRUE) {
        echo "Noul client a fost adăugat cu succes!";
    } else {
