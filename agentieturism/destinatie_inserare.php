...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Destinatie (id_Destinatie, Tara_des, Oras_des, Hotel_des, Adresa_des, Telefon_des) VALUES ('$id_destinatie','$tara', '$oras', '$hotel', '$adresa', '$telefon')";

    if ($conn->query($sql) === TRUE) {
        echo "Noua destinație a fost adăugată cu succes!";
    } else {
...
<body>
    <h2>Inserare Destinatie</h2>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
     <label for="id_destinatie">Id Destinatie:</label><br>
