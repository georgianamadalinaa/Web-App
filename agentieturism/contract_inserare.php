...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Contract (Nr_Contract, Id_angajat, Id_CNP, Id_Destinatie, Data_plecare, Nr_nopti, Transport, Suma_plata)
            VALUES ('$nr_contract', '$id_angajat', '$id_cnp', '$id_destinatie', '$data_plecare', '$nr_nopti', '$transport', '$suma_plata')";

    if ($conn->query($sql) === TRUE) {
        echo "Contractul a fost adăugat cu succes!";
    } else {
